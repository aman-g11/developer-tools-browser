...
export const ARIA_ATTRIBUTES = /* @__PURE__ */ new Set([
  "role",
...
export var DOMNodeEvents = /* @__PURE__ */ ((DOMNodeEvents2) => {
...
export class DOMNode extends Common.ObjectWrapper.ObjectWrapper {
  ...
  init(doc, isInShadowTree, payload, retainedNodes) {
    ...
    if (payload.templateContent) {
      this.templateContentInternal = DOMNode.create(this.#domModel, this.ownerDocument, true, payload.templateContent, retainedNodes);
    ...
    if (payload.importedDocument) {
      this.#importedDocument = DOMNode.create(this.#domModel, this.ownerDocument, true, payload.importedDocument, retainedNodes);
  ...
  path() {
    function getNodeKey(node2) {
      ...
      if (node2.isShadowRoot()) {
        return node2.shadowRootType() === DOMNode.ShadowRootTypes.UserAgent ? "u" : "a";
      }
...
export class DOMModel extends SDKModel {
  ...
  topLayerElementsUpdated() {
    void this.#topLayerThrottler.schedule(async () => {
      ...
      for (const [document, nodes2] of nodesByDocument) {
        let topLayerIdx = 1;
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["AttrModified"] = "AttrModified";
  Events2["AttrRemoved"] = "AttrRemoved";
  Events2["CharacterDataModified"] = "CharacterDataModified";
  Events2["DOMMutated"] = "DOMMutated";
  Events2["DocumentURLChanged"] = "DocumentURLChanged";
  Events2["NodeInserted"] = "NodeInserted";
  Events2["NodeRemoved"] = "NodeRemoved";
  Events2["DocumentUpdated"] = "DocumentUpdated";
  Events2["ChildNodeCountUpdated"] = "ChildNodeCountUpdated";
  Events2["DistributedNodesChanged"] = "DistributedNodesChanged";
  Events2["MarkersChanged"] = "MarkersChanged";
  Events2["TopLayerElementsChanged"] = "TopLayerElementsChanged";
  Events2["AffectedByStartingStylesFlagUpdated"] = "AffectedByStartingStylesFlagUpdated";
  Events2["AdoptedStyleSheetsModified"] = "AdoptedStyleSheetsModified";
  return Events2;
})(Events || {});
class DOMDispatcher {
  #domModel;
