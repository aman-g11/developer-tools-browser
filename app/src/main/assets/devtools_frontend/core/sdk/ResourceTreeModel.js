...
export class ResourceTreeModel extends SDKModel {
  ...
  onRequestUpdateDropped(event) {
    ...
    const resource = new Resource(
      ...
      frameId,
      data.loaderId,
      Common.ResourceType.resourceTypes[data.resourceType],
      data.mimeType,
      data.lastModified,
      null
    );
  ...
  addFramesRecursively(sameTargetParentFrame, frameTreePayload) {
    ...
    for (let i = 0; i < frameTreePayload.resources.length; ++i) {
      ...
      const resource = this.createResourceFromFramePayload(
        framePayload,
        subresource.url,
        Common.ResourceType.resourceTypes[subresource.type],
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["FrameAdded"] = "FrameAdded";
  Events2["FrameNavigated"] = "FrameNavigated";
  Events2["FrameDetached"] = "FrameDetached";
  Events2["FrameResized"] = "FrameResized";
  Events2["FrameWillNavigate"] = "FrameWillNavigate";
  Events2["DocumentOpened"] = "DocumentOpened";
  Events2["PrimaryPageChanged"] = "PrimaryPageChanged";
  Events2["ResourceAdded"] = "ResourceAdded";
  Events2["WillLoadCachedResources"] = "WillLoadCachedResources";
  Events2["CachedResourcesLoaded"] = "CachedResourcesLoaded";
  Events2["DOMContentLoaded"] = "DOMContentLoaded";
  Events2["LifecycleEvent"] = "LifecycleEvent";
  Events2["Load"] = "Load";
  Events2["PageReloadRequested"] = "PageReloadRequested";
  Events2["WillReloadPage"] = "WillReloadPage";
  Events2["InterstitialShown"] = "InterstitialShown";
  Events2["InterstitialHidden"] = "InterstitialHidden";
  Events2["BackForwardCacheDetailsUpdated"] = "BackForwardCacheDetailsUpdated";
  Events2["JavaScriptDialogOpening"] = "JavaScriptDialogOpening";
  return Events2;
})(Events || {});
export class ResourceTreeFrame {
  ...
  constructor(model, parentFrame, frameId, payload, creationStackTrace) {
    ...
    this.#unreachableUrl = payload && payload.unreachableUrl || Platform.DevToolsPath.EmptyUrlString;
  ...
  navigate(framePayload) {
    ...
    this.#unreachableUrl = framePayload.unreachableUrl || Platform.DevToolsPath.EmptyUrlString;
...
export var PrimaryPageChangeType = /* @__PURE__ */ ((PrimaryPageChangeType2) => {
