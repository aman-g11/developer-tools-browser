...
export class CSSModel extends SDKModel {
  ...
  constructor(target) {
    ...
    Common.Settings.Settings.instance().moduleSetting("css-source-maps-enabled").addChangeListener((event) => this.#sourceMapManager.setEnabled(event.data));
  }
  async colorScheme() {
    if (!this.#colorScheme) {
...
export var Events = /* @__PURE__ */ ((Events2) => {
  ...
  Events2["ModelDisposed"] = "ModelDisposed";
  Events2["PseudoStateForced"] = "PseudoStateForced";
  Events2["StartingStylesStateForced"] = "StartingStylesStateForced";
  ...
  Events2["ComputedStyleUpdated"] = "ComputedStyleUpdated";
  return Events2;
})(Events || {});
