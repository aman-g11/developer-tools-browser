...
export class RuntimeModel extends SDKModel {
  ...
  constructor(target) {
    ...
    Common.Settings.Settings.instance().moduleSetting("custom-formatters").addChangeListener(this.customFormattersStateChanged.bind(this));
  }
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["BindingCalled"] = "BindingCalled";
  Events2["ExecutionContextCreated"] = "ExecutionContextCreated";
  Events2["ExecutionContextDestroyed"] = "ExecutionContextDestroyed";
  Events2["ExecutionContextChanged"] = "ExecutionContextChanged";
  Events2["ExecutionContextOrderChanged"] = "ExecutionContextOrderChanged";
  Events2["ExceptionThrown"] = "ExceptionThrown";
  Events2["ExceptionRevoked"] = "ExceptionRevoked";
  Events2["ConsoleAPICalled"] = "ConsoleAPICalled";
  Events2["QueryObjectRequested"] = "QueryObjectRequested";
  return Events2;
})(Events || {});
