...
export class CookieModel extends SDKModel {
  ...
  constructor(target) {
    super(target);
    target.model(ResourceTreeModel)?.addEventListener(ResourceTreeModelEvents.PrimaryPageChanged, this.#onPrimaryPageChanged, this);
    target.model(NetworkManager)?.addEventListener(NetworkManagerEvents.ResponseReceived, this.#onResponseReceived, this);
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["COOKIE_LIST_UPDATED"] = "CookieListUpdated";
  return Events2;
})(Events || {});
