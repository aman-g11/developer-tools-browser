...
export var DataSaverOverride = /* @__PURE__ */ ((DataSaverOverride2) => {
...
export class EmulationModel extends SDKModel {
  ...
  constructor(target) {
    ...
    const mediaFeaturePrefersReducedTransparencySetting = Common.Settings.Settings.instance().moduleSetting(
  ...
  async updateTouch() {
    let configuration = {
      ...
      configuration: this.#touchMobile ? Protocol.Emulation.SetEmitTouchEventsForMouseRequestConfiguration.Mobile : Protocol.Emulation.SetEmitTouchEventsForMouseRequestConfiguration.Desktop
    };
...
export var EmulationModelEvents = /* @__PURE__ */ ((EmulationModelEvents2) => {
