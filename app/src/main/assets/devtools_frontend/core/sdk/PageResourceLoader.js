...
export class PageResourceLoader extends Common.ObjectWrapper.ObjectWrapper {
  ...
  async dispatchLoad(url, initiator, isBinary) {
    ...
    if (eligibleForLoadFromTarget) {
      ...
      const code = this.getLoadThroughTargetSetting().get() ? Host.UserMetrics.DeveloperResourceLoaded.FALLBACK_PER_PROTOCOL : Host.UserMetrics.DeveloperResourceLoaded.FALLBACK_PER_OVERRIDE;
