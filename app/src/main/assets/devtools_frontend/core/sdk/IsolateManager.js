...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["MEMORY_CHANGED"] = "MemoryChanged";
  return Events2;
})(Events || {});
export const MemoryTrendWindowMs = 12e4;
...
export class Isolate {
  ...
  async update() {
    ...
    IsolateManager.instance().dispatchEventToListeners("MemoryChanged" /* MEMORY_CHANGED */, this);
  }
  samplesCount() {
