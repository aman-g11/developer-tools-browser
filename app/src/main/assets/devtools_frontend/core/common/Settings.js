...
export class Deprecation {
  ...
  constructor({ deprecationNotice }) {
    ...
    this.experiment = deprecationNotice.experiment ? Root.Runtime.experiments.allConfigurableExperiments().find((e) => e.name === deprecationNotice.experiment) : void 0;
  }
}
export class Setting {
  ...
  setRegistration(registration) {
    ...
    if (deprecationNotice?.disabled) {
      const experiment = deprecationNotice.experiment ? Root.Runtime.experiments.allConfigurableExperiments().find((e) => e.name === deprecationNotice.experiment) : void 0;
...
export var SettingStorageType = /* @__PURE__ */ ((SettingStorageType2) => {
