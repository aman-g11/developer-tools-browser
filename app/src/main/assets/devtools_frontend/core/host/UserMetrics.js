...
export class UserMetrics {
  ...
  actionTaken(action) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(EnumeratedHistogram.ActionTaken, action, 201 /* MAX_VALUE */);
  }
  ...
  experimentChanged(experimentId, isEnabled) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(actionName, experiment, 112 /* MAX_VALUE */);
  }
  ...
  extensionEvalTarget(target) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      EnumeratedHistogram.ExtensionEvalTarget,
      target,
      3 /* MAX_VALUE */
    );
  }
...
export var SwatchType = /* @__PURE__ */ ((SwatchType2) => {
  ...
  SwatchType2[SwatchType2["GRID_LANES"] = 12] = "GRID_LANES";
...
export var ExtensionEvalTarget = /* @__PURE__ */ ((ExtensionEvalTarget2) => {
  ExtensionEvalTarget2[ExtensionEvalTarget2["WEB_PAGE"] = 0] = "WEB_PAGE";
  ExtensionEvalTarget2[ExtensionEvalTarget2["SAME_EXTENSION"] = 1] = "SAME_EXTENSION";
  ExtensionEvalTarget2[ExtensionEvalTarget2["OTHER_EXTENSION"] = 2] = "OTHER_EXTENSION";
  ExtensionEvalTarget2[ExtensionEvalTarget2["MAX_VALUE"] = 3] = "MAX_VALUE";
  return ExtensionEvalTarget2;
})(ExtensionEvalTarget || {});
