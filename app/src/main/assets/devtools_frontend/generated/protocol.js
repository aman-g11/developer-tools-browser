...
((Audits2) => {
  ...
  ((SharedDictionaryError2) => {
    ...
    SharedDictionaryError2["UseErrorNoCorpCrossOriginNoCorsRequest"] = "UseErrorNoCorpCrossOriginNoCorsRequest";
    ...
    SharedDictionaryError2["WriteErrorNoCorpCossOriginNoCorsRequest"] = "WriteErrorNoCorpCossOriginNoCorsRequest";
...
((Network2) => {
  ...
  ((DeviceBoundSessionFetchResult2) => {
    ...
    DeviceBoundSessionFetchResult2["KeyError"] = "KeyError";
  ...
  ((RefreshEventDetailsRefreshResult2) => {
    ...
    RefreshEventDetailsRefreshResult2["RefreshQuotaExceeded"] = "RefreshQuotaExceeded";
