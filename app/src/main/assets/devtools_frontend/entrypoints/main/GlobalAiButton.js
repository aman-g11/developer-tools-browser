...
const DELAY_BEFORE_PROMOTION_COLLAPSE_IN_MS = 5e3;
const PROMOTION_END_DATE = /* @__PURE__ */ new Date("2026-09-30");
...
export var GlobalAiButtonState = /* @__PURE__ */ ((GlobalAiButtonState2) => {
...
export class GlobalAiButton extends UI.Widget.Widget {
  ...
  #addHoverEventListeners() {
    UI.InspectorView.InspectorView.instance().tabbedPane.headerElement().addEventListener(
      "mouseenter",
      this.#handleMainToolbarMouseEnter
    );
    UI.InspectorView.InspectorView.instance().tabbedPane.headerElement().addEventListener(
      "mouseleave",
      this.#handleMainToolbarMouseLeave
    );
  }
