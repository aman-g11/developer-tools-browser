...
export const DEFAULT_VIEW = (input, _output, target) => {
  render(
    input.state === "start" ? widget(CSSOverviewStartView, { onStartCapture: input.onStartCapture }) : input.state === "processing" ? widget(CSSOverviewProcessingView, { onCancel: input.onCancel }) : widget(CSSOverviewCompletedView, {
