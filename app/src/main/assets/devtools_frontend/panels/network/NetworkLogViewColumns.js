...
export class NetworkLogViewColumns {
  ...
  setupWaterfall() {
    ...
    this.#dataGrid.addEventListener(
      DataGrid.ViewportDataGrid.Events.VIEWPORT_CALCULATED,
  ...
  createWaterfallHeader() {
    ...
    this.waterfallHeaderElement.setAttribute(
      "jslog",
      `${VisualLogging.tableHeader("waterfall").track({ click: true, resize: true })}`
    );
  ...
  #headerContextMenu(contextMenu) {
    ...
    responseSubMenu.footerSection().appendItem(
      i18nString(UIStrings.manageHeaderColumns),
    ...
    waterfallSubMenu.defaultSection().appendCheckboxItem(
      i18nString(UIStrings.startTime),
    ...
    waterfallSubMenu.defaultSection().appendCheckboxItem(
      i18nString(UIStrings.responseTime),
    ...
    waterfallSubMenu.defaultSection().appendCheckboxItem(
      i18nString(UIStrings.totalDuration),
...
var CalculatorTypes = /* @__PURE__ */ ((CalculatorTypes2) => {
  CalculatorTypes2["DURATION"] = "Duration";
  CalculatorTypes2["TIME"] = "Time";
  return CalculatorTypes2;
})(CalculatorTypes || {});
