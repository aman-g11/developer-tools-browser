...
const MAX_MESSAGE_SIZE = 1e3;
const MAX_STACK_TRACE_SIZE = 1e3;
const MAX_CODE_SIZE = 1e3;
export var SourceType = /* @__PURE__ */ ((SourceType2) => {
...
export class PromptBuilder {
  ...
  async getMessageSourceCode() {
    ...
    const mappedLocation = await Bindings.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance().rawLocationToUILocation(
      rawLocation
    );
