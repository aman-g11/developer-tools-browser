...
export class ScreencastView extends UI.Widget.VBox {
  ...
  repaint() {
    ...
    this.context.fillRect(
      0,
      this.screenOffsetTop * this.screenZoom + this.imageElement.naturalHeight * this.imageZoom,
      canvasWidth,
      canvasHeight
    );
  ...
  cssColor(color) {
    ...
    return Common.Color.Legacy.fromRGBA([color.r, color.g, color.b, color.a !== void 0 ? color.a : 1]).asString(Common.Color.Format.RGBA) || "";
  }
  quadToPath(quad) {
