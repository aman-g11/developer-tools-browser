...
export class InspectElementModeController {
  ...
  constructor() {
    ...
    SDK.TargetManager.TargetManager.instance().addModelListener(
      ...
      SDK.OverlayModel.Events.EXITED_INSPECT_MODE,
    ...
    this.showDetailedInspectTooltipSetting = Common.Settings.Settings.instance().moduleSetting("show-detailed-inspect-tooltip");
  ...
  toggleInspectMode() {
    ...
    if (this.isInInspectElementMode()) {
      ...
      mode = Common.Settings.Settings.instance().moduleSetting("show-ua-shadow-dom").get() ? Protocol.Overlay.InspectMode.SearchForUAShadowDOM : Protocol.Overlay.InspectMode.SearchForNode;
    }
    this.setMode(mode);
  }
