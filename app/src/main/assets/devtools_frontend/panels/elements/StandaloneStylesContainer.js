...
export class StandaloneStylesContainer extends Common.ObjectWrapper.eventMixin(
  UI.Widget.VBox
) {
  activeCSSAngle = null;
  ...
  #onUpdateFinished() {
    this.dispatchEventToListeners("StylesUpdateCompleted" /* STYLES_UPDATE_COMPLETED */);
  }
  #updateFilter() {
    for (const section of this.#sections) {
