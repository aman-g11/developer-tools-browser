...
export class LinearMemoryNavigator extends HTMLElement {
  ...
  #createAddressInput() {
    ...
    return html`<input
      ...
      @change=${this.#onAddressChange.bind(this, "Submitted" /* SUBMITTED */)}
      @input=${this.#onAddressChange.bind(this, "Edit" /* EDIT */)}
    />`;
  }
  ...
  #createButton(data) {
    return html`
      <devtools-button class="navigator-button"
        .data=${{ variant: Buttons.Button.Variant.ICON, iconName: data.icon, disabled: !data.enabled }}
