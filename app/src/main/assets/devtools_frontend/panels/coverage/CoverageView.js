...
const i18nTemplate = unboundI18nTemplate.bind(void 0, str_);
...
export const DEFAULT_VIEW = (input, output, target) => {
  render(html`
    ...
    input.needsReload === "bfcache-page" ? i18nString(UIStrings.bfcacheNoCapture) : i18nString(UIStrings.activationNoCapture),
    input.needsReload
...
export class CoverageView extends UI.Widget.VBox {
  ...
  constructor(view = DEFAULT_VIEW) {
    ...
    this.#coverageTypeComboBoxSetting = Common.Settings.Settings.instance().createSetting("coverage-view-coverage-type", 0);
  ...
  #updateStats() {
    ...
    this.#statusMessage = filterApplied ? i18nString(UIStrings.filteredSTotalS, { PH1: formatStat(filtered), PH2: formatStat(all) }) : formatStat(all);
  ...
  async exportReport() {
    ...
    const fileName = `Coverage-${Platform.DateUtilities.toISO8601Compact(/* @__PURE__ */ new Date())}.json`;
