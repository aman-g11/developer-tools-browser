...
export const DEFAULT_VIEW = (input, _output, target) => {
  ...
  Lit.render(html`
              ...
              <div class="chat-input-actions-left">
                ${input.context ? html`
                    <div class="select-element">
                      ${input.conversationType === AiAssistanceModel.AiHistoryStorage.ConversationType.STYLING ? html`
                          <devtools-button
                            .data=${{
    ...
    disabled: !input.isContextSelected
                      ...
                      >
                        ${input.context instanceof AiAssistanceModel.StylingAgent.NodeContext ? html`
                              <devtools-widget
                                class="title"
    ...
    if (ev.key === "Enter" || ev.key === " ") {
      void input.onContextClick();
              ...
              <div class="chat-input-actions-right">
                ...
                ${input.multimodalInputEnabled && !input.blockedByCrossOrigin ? html`
                    ${input.uploadImageInputEnabled ? html`
                        <devtools-button
    ...
    jslogContext: "stop"
                    ...
                    ></devtools-button>` : input.blockedByCrossOrigin ? html`
                      <devtools-button
