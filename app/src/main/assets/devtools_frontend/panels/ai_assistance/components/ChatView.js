...
const DEFAULT_VIEW = (input, output, target) => {
  ...
  render(html`
      ...
      <div class=${chatUiClasses}>
        <main @scroll=${input.handleScroll} ${ref((element) => {
          ...
          ` : html`
            <div class="empty-state-container">
              <div class="header">
                ...
                ${AiAssistanceModel.AiUtils.isGeminiBranding() ? html`
...
export class ChatView extends HTMLElement {
  ...
  #handleScroll = (ev) => {
    ...
    this.#pinScrollToBottom = ev.target.scrollTop + ev.target.clientHeight + SCROLL_ROUNDING_OFFSET > ev.target.scrollHeight;
  };
