...
const containerToBreakpointEntry = /* @__PURE__ */ new WeakMap();
const breakpointEntryToCheckbox = /* @__PURE__ */ new WeakMap();
...
export class XHRBreakpointsSidebarPane extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    this.#addButton = new UI.Toolbar.ToolbarButton(
      i18nString(UIStrings.addXhrfetchBreakpoint),
      "plus",
      void 0,
  ...
  async addButtonClicked() {
    ...
    const config = new UI.InplaceEditor.Config(commit, cancel, void 0);
  ...
  contextMenu(breakKeyword, event) {
    ...
    contextMenu.defaultSection().appendItem(
      removeAllTitle,
      removeAllBreakpoints.bind(this),
