...
export class StatusView {
  ...
  render() {
    if (!this.dialogRoot) {
      this.dialogRoot = UI.UIUtils.createShadowRootWithCoreStyles(this.dialog.contentElement, { cssFile: lighthouseDialogStyles });
...
export const fastFactRotationInterval = 6e3;
export const minimumTextVisibilityDuration = 3e3;
