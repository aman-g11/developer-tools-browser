...
export class StorageBucketsTreeParentElement extends ExpandableApplicationPanelTreeElement {
  ...
  constructor(storagePanel) {
    super(
      storagePanel,
      i18nString(UIStrings.storageBuckets),
      i18nString(UIStrings.noStorageBuckets),
      i18nString(UIStrings.storageBucketsDescription),
      "storage-buckets"
    );
  ...
  initialize() {
    ...
    SDK.TargetManager.TargetManager.instance().addModelListener(
      SDK.StorageBucketsModel.StorageBucketsModel,
      SDK.StorageBucketsModel.Events.BUCKET_CHANGED,
      this.bucketChanged,
      this
    );
...
export class StorageBucketsTreeElement extends ExpandableApplicationPanelTreeElement {
  ...
  onselect(selectedByUser) {
    ...
    if (!this.view) {
      this.view = LegacyWrapper.LegacyWrapper.legacyWrapper(UI.Widget.Widget, new StorageMetadataView.StorageMetadataView());
