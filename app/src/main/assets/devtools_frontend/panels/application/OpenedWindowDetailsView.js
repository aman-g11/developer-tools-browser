...
async function maybeCreateLinkToElementsPanel(opener) {
  ...
  const linkElement = linkifyIcon(
    "code-circle",
    i18nString(UIStrings.clickToOpenInElementsPanel),
...
export class OpenedWindowDetailsView extends UI.Widget.VBox {
  ...
  constructor(targetInfo, isWindowClosed) {
    ...
    this.#urlFieldValue = this.documentSection.appendField(i18nString(UIStrings.url)).createChild("div", "text-ellipsis");
