...
((StorageItemsToolbar2) => {
  ...
  ((Events2) => {
    ...
    Events2["FILTER_CHANGED"] = "FilterChanged";
    Events2["DELETE_ALL"] = "DeleteAll";
    Events2["DELETE_SELECTED"] = "DeleteSelected";
  })(Events = StorageItemsToolbar2.Events || (StorageItemsToolbar2.Events = {}));
