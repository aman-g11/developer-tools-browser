...
export class InterestGroupStorageView extends UI.SplitWidget.SplitWidget {
  ...
  constructor(detailsGetter) {
    ...
    this.noDisplayView = new UI.EmptyWidget.EmptyWidget(i18nString(UIStrings.noValueSelected), i18nString(UIStrings.clickToDisplayBody));
    this.noDataView = new UI.EmptyWidget.EmptyWidget(i18nString(UIStrings.noDataAvailable), i18nString(UIStrings.noDataDescription));
  ...
  async onFocus(event) {
    ...
    let details = null;
    if (eventType !== Protocol.Storage.InterestGroupAccessType.AdditionalBid && eventType !== Protocol.Storage.InterestGroupAccessType.AdditionalBidWin && eventType !== Protocol.Storage.InterestGroupAccessType.TopLevelAdditionalBid) {
