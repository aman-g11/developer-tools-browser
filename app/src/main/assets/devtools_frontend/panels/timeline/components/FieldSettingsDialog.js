          ...
          <details aria-label=${i18nString(UIStrings.advanced)}>
            ...
            <div class="advanced-section-contents">
              ...
              <input
                ...
                placeholder=${ifDefined(this.#urlOverrideEnabled ? i18nString(UIStrings.url) : void 0)}
              />
              ${this.#urlOverrideWarning ? html`<div class="warning" role="alert" aria-label=${this.#urlOverrideWarning}>${this.#urlOverrideWarning}</div>` : nothing}
            </div>
          </details>
