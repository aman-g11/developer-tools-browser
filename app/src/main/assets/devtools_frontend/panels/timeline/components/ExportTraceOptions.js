...
const checkboxesWithInfoDialog = /* @__PURE__ */ new Set(["resource-content", "script-source-maps"]);
export class ExportTraceOptions extends HTMLElement {
  ...
  #includeResourceContentCheckbox = UI.UIUtils.CheckboxLabel.create(
    /* title*/
    i18nString(UIStrings.includeResourceContent),
    /* checked*/
  ...
  #includeSourceMapsCheckbox = UI.UIUtils.CheckboxLabel.create(
    /* title*/
    i18nString(UIStrings.includeSourcemap),
    /* checked*/
  ...
  #shouldCompressCheckbox = UI.UIUtils.CheckboxLabel.create(
    /* title*/
    i18nString(UIStrings.shouldCompress),
    /* checked*/
