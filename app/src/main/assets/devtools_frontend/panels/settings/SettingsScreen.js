...
export class SettingsScreen extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    const settingsTitleElement = UI.UIUtils.createShadowRootWithCoreStyles(settingsLabelElement, { cssFile: settingsScreenStyles }).createChild("div", "settings-window-title");
    ...
    this.tabbedLocation = UI.ViewManager.ViewManager.instance().createTabbedLocation(
      () => SettingsScreen.revealSettingsScreen(),
      "settings-view"
    );
