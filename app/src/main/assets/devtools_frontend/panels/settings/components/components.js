...
/*# sourceURL=${import.meta.resolve("./syncSection.css")} */`;var n={syncDisabled:"To turn this setting on, you must enable Chrome sync.",preferencesSyncDisabled:"You need to first enable saving `Chrome` settings in your `Google` account.",signedIn:"Signed into Chrome as:",notSignedIn:"You're not signed into Chrome.",gdpStandardPlan:"Standard plan",gdpPremiumSubscription:"Premium",gdpProSubscription:"Pro",gdpUnknownSubscription:"Unknown plan",signUp:"Sign up",viewProfile:"View profile",tooltipDisclaimerText:"When you qualify for a badge, the badge\u2019s identifier and the type of activity you did to earn it are sent to Google",relevantData:"Relevant data",dataDisclaimer:"({PH1} is sent to Google)"},x=h.i18n.registerUIStrings("panels/settings/components/SyncSection.ts",n),s=h.i18n.getLocalizedString.bind(void 0,x),w=r.i18nTemplate.bind(void 0,x),{html:o,render:L,Directives:{ref:U}}=r;function G(e){if(!e.activeSubscription||e.activeSubscription.subscriptionStatus!==a.GdpClient.SubscriptionStatus.ENABLED)return s(n.gdpStandardPlan);switch(e.activeSubscription.subscriptionTier){case a.GdpClient.SubscriptionTier.PREMIUM_ANNUAL:case a.GdpClient.SubscriptionTier.PREMIUM_MONTHLY:return s(n.gdpPremiumSubscription);case a.GdpClient.SubscriptionTier.PRO_ANNUAL:case a.GdpClient.SubscriptionTier.PRO_MONTHLY:return s(n.gdpProSubscription);default:return s(n.gdpUnknownSubscription)}}var A=(e,i,t)=>{let g=()=>{if(!e.syncInfo.accountEmail)return r.nothing;let p=e.warningType==="SYNC_DISABLED"?s(n.syncDisabled):s(n.preferencesSyncDisabled);return o`
      <div class="setting-checkbox-container">
        ...
        ${e.warningType?o`
          <devtools-button
            ...
            .iconName=${"info"}
            .variant=${l.Button.Variant.ICON}
            .size=${l.Button.Size.SMALL}
    ...
    `},I=()=>e.syncInfo.accountEmail?o`
      ...
      `,B=()=>{if(!e.isEligibleToCreateGdpProfile&&!e.gdpProfile)return r.nothing;let p=a.GdpClient.isBadgesEnabled()&&e.receiveBadgesSetting,u=()=>o`
        ...
        ${e.gdpProfile?o`
          <div class="gdp-profile-details-content">
            ...
            <div class="plan-details">
              ...
              ${p?o`
                <div class="setting-container" ${U(d=>{i.highlightReceiveBadgesSetting=()=>{d&&E.PanelUtils.highlightElement(d)}})}>
                  <setting-checkbox class="setting-checkbox"
                    .data=${{setting:e.receiveBadgesSetting}}
                    @change=${d=>e.onReceiveBadgesSettingClick(d)}>
                  </setting-checkbox>
                  <span>${w(n.dataDisclaimer,{PH1:o`
        ...
        `:o`
          <div class="gdp-profile-sign-up-content">
            ...
            <devtools-button
              ...
              .variant=${l.Button.Variant.OUTLINED}>
                ${s(n.signUp)}
            </devtools-button>
          </div>
        `}
  ...
  `,t)},k=(e=>(e.SYNC_DISABLED="SYNC_DISABLED",e.PREFERENCES_SYNC_DISABLED="PREFERENCES_SYNC_DISABLED",e))(k||{}),v=class extends b.Widget.Widget{#e={isSyncActive:!1};#i;#t;#n=!1;#s;#o;#a={};constructor(i,t=A){super(i),this.#o=t,this.#t=f.Settings.Settings.instance().moduleSetting("receive-gdp-badges"),this.#i=f.Settings.moduleSetting("sync-preferences")}wasShown(){super.wasShown(),this.requestUpdate()}set syncInfo(i){this.#e=i,this.requestUpdate(),i.accountEmail&&this.#r()}async highlightReceiveBadgesSetting(){this.requestUpdate(),await this.updateComplete,this.#a.highlightReceiveBadgesSetting?.()}performUpdate(){let i=!this.#e.isSyncActive||!this.#e.arePreferencesSynced;this.#i?.setDisabled(i);let t;this.#e.isSyncActive?this.#e.arePreferencesSynced||(t="PREFERENCES_SYNC_DISABLED"):t="SYNC_DISABLED";let g={syncInfo:this.#e,syncSetting:this.#i,receiveBadgesSetting:this.#t,gdpProfile:this.#s,isEligibleToCreateGdpProfile:a.GdpClient.isGdpProfilesAvailable()&&this.#n,onSignUpClick:this.#c.bind(this),onReceiveBadgesSettingClick:this.#d.bind(this),onWarningClick:this.#l.bind(this),warningType:t};this.#o(g,this.#a,this.contentElement)}#c(){C.GdpSignUpDialog.show({onSuccess:this.#r.bind(this)})}#d(i){let t=i.target;c.UserBadges.instance().initialize().then(()=>{t.checked&&c.UserBadges.instance().recordAction(c.BadgeAction.RECEIVE_BADGES_SETTING_ENABLED)})}#l(i){let t=this.#e.isSyncActive?"chrome://settings/syncSetup/advanced":"chrome://settings/syncSetup";S.openInNewTab(t),i.consume()}async#r(){if(!a.GdpClient.isGdpProfilesAvailable())return;let i=await a.GdpClient.GdpClient.instance().getProfile();i&&(this.#s=i.profile??void 0,this.#n=i.isEligible,this.requestUpdate())}};export{P as SyncSection};
