...
export class FrameworkIgnoreListSettingsTab extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    const ignoreListContentScripts = generalExclusionGroup.createChild("div", "ignore-list-option").appendChild(SettingsUI.SettingsUI.createSettingCheckbox(
    ...
    const automaticallyIgnoreList = automaticallyIgnoreListContainer.appendChild(SettingsUI.SettingsUI.createSettingCheckbox(
    ...
    const ignoreListAnonymousScripts = generalExclusionGroup.createChild("div", "ignore-list-option").appendChild(SettingsUI.SettingsUI.createSettingCheckbox(
    ...
    this.setting = Common.Settings.Settings.instance().moduleSetting("skip-stack-frames-pattern");
