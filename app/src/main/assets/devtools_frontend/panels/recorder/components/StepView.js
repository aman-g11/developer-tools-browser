...
export var AddStepPosition = /* @__PURE__ */ ((AddStepPosition2) => {
    ...
    <div>
      ...
      if (stepOrSection) {
        ...
        <div class="summary">
          ...
          >
            ${isExpandable ? html`<devtools-icon
                    class="chevron"
  ...
  #handleStepAction(event) {
    switch (event.itemValue) {
      case "add-step-before": {
        ...
        this.contentElement.dispatchEvent(new AddStep(stepOrSection, "before" /* BEFORE */));
        break;
      }
      case "add-step-after": {
        const stepOrSection = this.#viewInput.step || this.#viewInput.section;
        ...
        this.contentElement.dispatchEvent(new AddStep(stepOrSection, "after" /* AFTER */));
        break;
      }
      case "remove-step": {
        ...
        this.contentElement.dispatchEvent(
          new RemoveStep(this.#viewInput.step || causingStep)
        );
        break;
      }
      case "add-breakpoint": {
