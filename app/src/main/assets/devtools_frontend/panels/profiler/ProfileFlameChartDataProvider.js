...
export class OverviewPane extends Common.ObjectWrapper.eventMixin(
  ...
  constructor(dataProvider) {
    ...
    this.overviewGrid.addEventListener(
      PerfUI.OverviewGrid.Events.WINDOW_CHANGED_WITH_POSITION,
  ...
  update() {
    ...
    this.resetCanvas(
      ...
      this.overviewContainer.clientHeight - PerfUI.FlameChart.RulerHeight
    );
...
export var OverviewPaneEvents = /* @__PURE__ */ ((OverviewPaneEvents2) => {
