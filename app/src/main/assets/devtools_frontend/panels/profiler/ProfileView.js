...
export class ProfileView extends UI.View.SimpleView {
  ...
  constructor() {
    ...
    this.viewSelectComboBox = new UI.Toolbar.ToolbarComboBox(
      ...
      i18nString(UIStrings.profileViewMode),
      void 0,
      "profile-view.selected-view"
    );
    this.focusButton = new UI.Toolbar.ToolbarButton(
      i18nString(UIStrings.focusSelectedFunction),
      "eye",
      void 0,
    ...
    this.excludeButton = new UI.Toolbar.ToolbarButton(
      i18nString(UIStrings.excludeSelectedFunction),
      "cross",
      void 0,
    ...
    this.resetButton = new UI.Toolbar.ToolbarButton(
      i18nString(UIStrings.restoreAllFunctions),
      "refresh",
      void 0,
  ...
  initialize(nodeFormatter) {
    ...
    this.viewType = Common.Settings.Settings.instance().createSetting("profile-view", "Heavy" /* HEAVY */);
    ...
    const options = new Map(
      viewTypes.map((type) => [type, this.viewSelectComboBox.createOption(optionNames.get(type), type)])
    );
...
export class WritableProfileHeader extends ProfileHeader {
  ...
  async saveToFile() {
    ...
    if (!this.fileName) {
      const now = Platform.DateUtilities.toISO8601Compact(/* @__PURE__ */ new Date());
