...
export class IsolateSelector extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    UI.Tooltip.Tooltip.install(
      this.totalTrendDiv,
      i18nString(UIStrings.totalPageJsHeapSizeChangeTrend, { PH1: trendIntervalMinutes })
    );
  ...
  wasShown() {
    ...
    SDK.IsolateManager.IsolateManager.instance().addEventListener(
      SDK.IsolateManager.Events.MEMORY_CHANGED,
...
export class ListItem {
  ...
  constructor(isolate) {
    ...
    UI.Tooltip.Tooltip.install(
      this.trendDiv,
      i18nString(UIStrings.heapSizeChangeTrendOverTheLastS, { PH1: trendIntervalMinutes })
    );
