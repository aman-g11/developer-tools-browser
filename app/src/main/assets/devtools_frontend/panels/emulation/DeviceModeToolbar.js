...
export class DeviceModeToolbar {
  ...
  createMainToolbar() {
    ...
    mainToolbar.appendToolbarItem(new UI.Toolbar.ToolbarItem(this.createEmptyToolbarElement()));
    this.scaleItem = new UI.Toolbar.ToolbarComboBox(this.onScaleChange.bind(this), i18nString(UIStrings.zoom), "dark-text", "scale");
    ...
    const autoAdjustScaleButton = new UI.Toolbar.ToolbarSettingToggle(
      ...
      "center-focus-weak",
      i18nString(UIStrings.autoadjustZoom)
    );
    mainToolbar.appendToolbarItem(autoAdjustScaleButton);
    mainToolbar.appendToolbarItem(new UI.Toolbar.ToolbarItem(this.createEmptyToolbarElement()));
    this.deviceScaleItem = new UI.Toolbar.ToolbarComboBox(
      this.onDeviceScaleChange.bind(this),
      i18nString(UIStrings.devicePixelRatio),
      "dark-text",
      "device-pixel-ratio"
    );
    ...
    this.postureItem = new UI.Toolbar.ToolbarComboBox(
      this.onPostureChange.bind(this),
      i18nString(UIStrings.devicePosture),
      "dark-text",
      "device-posture"
    );
  ...
  createOptionsToolbar() {
    ...
    const moreOptionsButton = new UI.Toolbar.ToolbarMenuButton(
      this.appendOptionsMenuItems.bind(this),
      true,
      void 0,
      "more-options",
      "dots-vertical"
  ...
  appendOptionsMenuItems(contextMenu) {
    ...
    appendToggleItem(
      ...
      i18nString(UIStrings.hideDeviceFrame),
      i18nString(UIStrings.showDeviceFrame),
      model.type() !== EmulationModel.DeviceModeModel.Type.Device,
      "device-frame"
    );
    appendToggleItem(
      contextMenu.headerSection(),
