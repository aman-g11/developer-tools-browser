var h=Object.defineProperty;var c=(i,e)=>{for(var t in e)h(i,t,{get:e[t],enumerable:!0})};var d={};c(d,{SizeInputElement:()=>a});import*as s from"./../../../models/emulation/emulation.js";import*as n from"./../../../ui/legacy/legacy.js";import{html as u,render as m}from"./../../../ui/lit/lit.js";import*as l from"./../../../ui/visual_logging/visual_logging.js";var o=class i extends Event{constructor(e){super(i.eventName),this.size=e}static eventName="sizechanged"};function r(i){return Number(i.target.value)}var a=class extends HTMLElement{#a=this.attachShadow({mode:"open"});#e=!1;#t="0";#i="";#s;#o;constructor(e,{jslogContext:t}){super(),this.#s=e,this.#o=t}connectedCallback(){this.render()}set disabled(e){this.#e=e,this.render()}set size(e){this.#t=e,this.render()}set placeholder(e){this.#i=e,this.render()}render(){m(u`
      <style>
        input {
          /*
