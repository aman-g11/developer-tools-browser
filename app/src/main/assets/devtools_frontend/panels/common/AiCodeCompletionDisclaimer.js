...
export const DEFAULT_SUMMARY_TOOLBAR_VIEW = (input, output, target) => {
  if (input.aidaAvailability !== Host.AidaClient.AidaAccessPreconditions.AVAILABLE || !input.disclaimerTooltipId || !input.spinnerTooltipId || !input.panel) {
...
const MINIMUM_LOADING_STATE_TIMEOUT = 1e3;
