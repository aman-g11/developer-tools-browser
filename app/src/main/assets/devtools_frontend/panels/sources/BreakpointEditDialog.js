  ...
  render(
    ...
    <div class=dialog-header>
      <devtools-toolbar class=source-frame-breakpoint-toolbar>Line ${input.editorLineNumber + 1}:
        <select
          class=type-selector
          title=${input.breakpointType === SDK.DebuggerModel.BreakpointType.LOGPOINT ? i18nString(UIStrings.logAMessageToConsoleDoNotBreak) : i18nString(UIStrings.pauseOnlyWhenTheConditionIsTrue)}
