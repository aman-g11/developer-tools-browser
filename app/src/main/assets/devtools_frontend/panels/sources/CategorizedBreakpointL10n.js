...
const LOCALIZED_INSTRUMENTATION_NAMES = {
  [SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_BIDDER_WORKLET_BIDDING_START]: i18nLazyString(UIStrings.beforeBidderWorkletBiddingStart),
  [SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_BIDDER_WORKLET_REPORTING_START]: i18nLazyString(UIStrings.beforeBidderWorkletReportingStart),
  [SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_SELLER_WORKLET_SCORING_START]: i18nLazyString(UIStrings.beforeSellerWorkletScoringStart),
  [SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_SELLER_WORKLET_REPORTING_START]: i18nLazyString(UIStrings.beforeSellerWorkletReportingStart),
  ...
  [SDK.EventBreakpointsModel.InstrumentationNames.SET_TIMEOUT_CALLBACK]: i18nLazyString(UIStrings.setTimeoutOrIntervalFired, { PH1: "setTimeout" }),
  ...
  [SDK.EventBreakpointsModel.InstrumentationNames.SET_INTERVAL_CALLBACK]: i18nLazyString(UIStrings.setTimeoutOrIntervalFired, { PH1: "setInterval" }),
  [SDK.EventBreakpointsModel.InstrumentationNames.SCRIPT_FIRST_STATEMENT]: i18nLazyString(UIStrings.scriptFirstStatement),
  [SDK.EventBreakpointsModel.InstrumentationNames.SCRIPT_BLOCKED_BY_CSP]: i18nLazyString(UIStrings.scriptBlockedByContentSecurity),
  [SDK.EventBreakpointsModel.InstrumentationNames.SHARED_STORAGE_WORKLET_SCRIPT_FIRST_STATEMENT]: i18nLazyString(UIStrings.scriptFirstStatement),
  [SDK.EventBreakpointsModel.InstrumentationNames.REQUEST_ANIMATION_FRAME]: i18nLazyString(UIStrings.requestAnimationFrame),
  [SDK.EventBreakpointsModel.InstrumentationNames.CANCEL_ANIMATION_FRAME]: i18nLazyString(UIStrings.cancelAnimationFrame),
  [SDK.EventBreakpointsModel.InstrumentationNames.REQUEST_ANIMATION_FRAME_CALLBACK]: i18nLazyString(UIStrings.animationFrameFired),
  ...
  [SDK.EventBreakpointsModel.InstrumentationNames.CANVAS_CONTEXT_CREATED]: i18nLazyString(UIStrings.createCanvasContext),
  [SDK.EventBreakpointsModel.InstrumentationNames.GEOLOCATION_GET_CURRENT_POSITION]: i18n.i18n.lockedLazyString("getCurrentPosition"),
  [SDK.EventBreakpointsModel.InstrumentationNames.GEOLOCATION_WATCH_POSITION]: i18n.i18n.lockedLazyString("watchPosition"),
  [SDK.EventBreakpointsModel.InstrumentationNames.NOTIFICATION_REQUEST_PERMISSION]: i18n.i18n.lockedLazyString("requestPermission"),
  ...
  [SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_CREATED]: i18nLazyString(UIStrings.createAudiocontext),
  [SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_CLOSED]: i18nLazyString(UIStrings.closeAudiocontext),
  [SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_RESUMED]: i18nLazyString(UIStrings.resumeAudiocontext),
  [SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_SUSPENDED]: i18nLazyString(UIStrings.suspendAudiocontext)
};
