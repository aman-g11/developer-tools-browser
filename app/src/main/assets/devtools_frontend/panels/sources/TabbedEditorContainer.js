    ...
    if (tabId2) {
      ...
      if (uiSourceCode.loadError()) {
        ...
        if (automaticFileSystem?.state === "disconnected") {
          ...
          tooltip2.append(uiI18n.getFormatLocalizedString(
            str_,
            UIStrings.changesWereNotSavedToFileSystemToSaveAddFolderToWorkspace,
            { PH1: link }
          ));
        } else {
          ...
          tooltip2.append(uiI18n.getFormatLocalizedString(
            str_,
            UIStrings.changesWereNotSavedToFileSystemToSaveSetUpYourWorkspace,
            { PH1: link }
          ));
        }
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["EDITOR_SELECTED"] = "EditorSelected";
  Events2["EDITOR_CLOSED"] = "EditorClosed";
  return Events2;
})(Events || {});
