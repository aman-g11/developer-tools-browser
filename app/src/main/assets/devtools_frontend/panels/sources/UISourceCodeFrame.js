...
export class UISourceCodeFrame extends Common.ObjectWrapper.eventMixin(
  ...
  constructor(uiSourceCode) {
    ...
    Common.Settings.Settings.instance().moduleSetting("persistence-network-overrides-enabled").addChangeListener(this.onNetworkPersistenceChanged, this);
    ...
    if (this.#persistenceBinding) {
      ...
      this.#messageAndDecorationListeners = [
        ...
        networkSourceCode.addEventListener(
          Workspace.UISourceCode.Events.DecorationChanged,
  ...
  #canEditSource() {
    ...
    if (this.#uiSourceCode.project().type() === Workspace.Workspace.projectTypes.Network && Persistence.NetworkPersistenceManager.NetworkPersistenceManager.instance().active()) {
      return true;
    }
  ...
  dispose() {
    ...
    this.detach();
    Common.Settings.Settings.instance().moduleSetting("persistence-network-overrides-enabled").removeChangeListener(this.onNetworkPersistenceChanged, this);
  }
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["TOOLBAR_ITEMS_CHANGED"] = "ToolbarItemsChanged";
  return Events2;
})(Events || {});
