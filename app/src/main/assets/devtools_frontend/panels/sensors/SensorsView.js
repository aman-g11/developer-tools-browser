...
export class SensorsView extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    this.deviceOrientationSetting = Common.Settings.Settings.instance().createSetting("emulation.device-orientation-override", "");
  ...
  renderLocationSection(location, customLocationsSetting) {
    ...
    const manageButton = UI.UIUtils.createTextButton(
      ...
      () => Common.Revealer.reveal(customLocationsSetting),
    ...
    group.appendChild(UI.UIUtils.createOption(
      i18nString(UIStrings.locationUnavailable),
      NonPresetOptions.Unavailable,
      "unavailable"
    ));
    ...
    this.latitudeSetter = UI.UIUtils.bindInput(
      this.latitudeInput,
      this.applyLocationUserInput.bind(this),
      SDK.EmulationModel.Location.latitudeValidator,
      true,
      0.1
    );
    ...
    this.longitudeSetter = UI.UIUtils.bindInput(
      this.longitudeInput,
      this.applyLocationUserInput.bind(this),
      SDK.EmulationModel.Location.longitudeValidator,
      true,
      0.1
    );
    ...
    this.timezoneSetter = UI.UIUtils.bindInput(
      this.timezoneInput,
      this.applyLocationUserInput.bind(this),
      SDK.EmulationModel.Location.timezoneIdValidator,
      false
    );
    ...
    this.localeSetter = UI.UIUtils.bindInput(
      this.localeInput,
      this.applyLocationUserInput.bind(this),
      SDK.EmulationModel.Location.localeValidator,
      false
    );
    ...
    this.accuracySetter = UI.UIUtils.bindInput(
      this.accuracyInput,
      this.applyLocationUserInput.bind(this),
      (value) => SDK.EmulationModel.Location.accuracyValidator(value).valid,
      true,
      1
    );
  ...
  #locationSelectChanged() {
    ...
    if (value === NonPresetOptions.NoOverride) {
      ...
      this.#locationOverrideEnabled = true;
      this.#location = new SDK.EmulationModel.Location(0, 0, "", "", SDK.EmulationModel.Location.DEFAULT_ACCURACY, true);
    } else {
      this.#locationOverrideEnabled = true;
      ...
      this.#location = new SDK.EmulationModel.Location(
        ...
        coordinates.locale,
        coordinates.accuracy || SDK.EmulationModel.Location.DEFAULT_ACCURACY,
        false
      );
  ...
  createDeviceOrientationSection() {
    ...
    this.orientationSelectElement.appendChild(UI.UIUtils.createOption(
      orientationOffOption.title,
      orientationOffOption.orientation,
      orientationOffOption.jslogContext
    ));
  ...
  createAxisInput(parentElement, input, label, validator) {
    ...
    div.appendChild(UI.UIUtils.createLabel(
      label,
      /* className */
      "",
      input
  ...
  createDeviceOrientationOverrideElement(deviceOrientation) {
    ...
    const resetButton = UI.UIUtils.createTextButton(
      ...
      this.resetDeviceOrientation.bind(this),
...
export var DeviceOrientationModificationSource = /* @__PURE__ */ ((DeviceOrientationModificationSource2) => {
