...
import { formatterWorkerPool, ScopeKind } from "../../formatter/FormatterWorkerPool.js";
...
`;
  ...
  async #getCallStack() {
    ...
    const stackTrace = await Bindings.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance().createStackTraceFromDebuggerPaused(
      details,
