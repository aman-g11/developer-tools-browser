...
export class AiCodeCompletion {
  ...
  #buildRequest(prefix, suffix, inferenceLanguage = Host.AidaClient.AidaInferenceLanguage.JAVASCRIPT, additionalFiles) {
    ...
    if (!additionalContextFiles) {
      additionalContextFiles = this.#panel === "console" /* CONSOLE */ ? [{
...
export var ContextFlavor = /* @__PURE__ */ ((ContextFlavor2) => {
  ContextFlavor2["CONSOLE"] = "console";
  ContextFlavor2["SOURCES"] = "sources";
  ContextFlavor2["STYLES"] = "styles";
  return ContextFlavor2;
})(ContextFlavor || {});
