...
export class Importer {
  ...
  static fillRequestFromHAREntry(request, entry, pageLoad) {
    ...
    if (request.mimeType === Platform.MimeType.MimeType.EVENTSTREAM && contentText) {
      ...
      const parser = new SDK.ServerSentEventProtocol.ServerSentEventsParser(onEvent, charset ?? void 0);
    ...
    const responseCookies = entry.response.cookies.map(this.fillCookieFromHARCookie.bind(this, SDK.Cookie.Type.RESPONSE));
