...
const styleSheetRangeMap = /* @__PURE__ */ new WeakMap();
const scriptRangeMap = /* @__PURE__ */ new WeakMap();
const boundUISourceCodes = /* @__PURE__ */ new WeakSet();
...
class ModelInfo {
  ...
  acceptsResource(resource) {
    ...
    if (resourceType !== Common.ResourceType.resourceTypes.Image && resourceType !== Common.ResourceType.resourceTypes.Font && resourceType !== Common.ResourceType.resourceTypes.Document && resourceType !== Common.ResourceType.resourceTypes.Manifest && resourceType !== Common.ResourceType.resourceTypes.Fetch && resourceType !== Common.ResourceType.resourceTypes.XHR) {
      return false;
    }
    if (resourceType === Common.ResourceType.resourceTypes.Image && resource.mimeType && !resource.mimeType.startsWith("image")) {
      return false;
    }
    if (resourceType === Common.ResourceType.resourceTypes.Font && resource.mimeType && !resource.mimeType.includes("font")) {
      return false;
    }
    if ((resourceType === Common.ResourceType.resourceTypes.Image || resourceType === Common.ResourceType.resourceTypes.Font) && Common.ParsedURL.schemeIs(resource.contentURL(), "data:")) {
      return false;
    }
    return true;
  }
