...
`,c=class{#i=crypto.randomUUID();#e;#t;constructor(t){this.#e=t.aidaClient,this.#t=t.serverSideLoggingEnabled??!1,n.Runtime.hostConfig.devToolsGeminiRebranding?.enabled&&(this.#t=!1)}#n(t,e,d=o.AidaClient.AidaInferenceLanguage.JAVASCRIPT){let s=o.AidaClient.convertToUserTierEnum(this.#r);function a(i){return typeof i=="number"&&i>=0?i:void 0}return t=e+t+`
