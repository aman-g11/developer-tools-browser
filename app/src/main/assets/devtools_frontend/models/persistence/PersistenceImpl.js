...
export class PersistenceImpl extends Common.ObjectWrapper.ObjectWrapper {
  ...
  syncContent(uiSourceCode, newContent, encoded) {
    ...
    const target = Bindings.NetworkProject.NetworkProject.targetForUISourceCode(binding.network);
    if (target && target.type() === SDK.Target.Type.NODE) {
      void other.requestContentData().then((contentDataOrError) => TextUtils.ContentData.ContentData.textOr(contentDataOrError, "")).then((currentContent) => {
...
const statusBindings = /* @__PURE__ */ new WeakMap();
const mutedCommits = /* @__PURE__ */ new WeakSet();
const mutedWorkingCopies = /* @__PURE__ */ new WeakSet();
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["BindingCreated"] = "BindingCreated";
  Events2["BindingRemoved"] = "BindingRemoved";
  return Events2;
})(Events || {});
