...
import { ToolbarButton, ToolbarText, ToolbarToggle } from "./Toolbar.js";
...
export class SearchableView extends VBox {
  ...
  constructor(searchable, replaceable, settingName, element) {
    ...
    this.replaceToggleButton = new ToolbarToggle(i18nString(UIStrings.enableFindAndReplace), "replace", void 0, "replace");
    ...
    this.replaceInputElement.setAttribute(
      "jslog",
      `${VisualLogging.textField("replace").track({ change: true, keydown: "Enter" })}`
    );
    ...
    this.searchNavigationPrevElement = new ToolbarButton(i18nString(UIStrings.searchPrevious), "chevron-up", void 0, "select-previous");
    ...
    this.searchNavigationNextElement = new ToolbarButton(i18nString(UIStrings.searchNext), "chevron-down", void 0, "select-next");
