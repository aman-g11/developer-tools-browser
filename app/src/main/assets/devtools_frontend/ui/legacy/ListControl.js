...
export var ListMode = /* @__PURE__ */ ((ListMode2) => {
...
export class ListControl {
  ...
  viewportResized() {
    ...
    this.clearViewport();
    this.updateViewport(
      Platform.NumberUtilities.clamp(scrollTop, 0, this.totalHeight() - viewportHeight),
      viewportHeight
    );
  }
  ...
  scrollIntoView(index, center) {
    ...
    if (center) {
      ...
      this.updateViewport(
        Platform.NumberUtilities.clamp(scrollTo, 0, this.totalHeight() - viewportHeight),
        viewportHeight
      );
      return;
    }
