...
export class FontEditor extends Common.ObjectWrapper.eventMixin(UI.Widget.VBox) {
  ...
  constructor(propertyMap) {
    ...
    this.contentElement.setAttribute(
      "jslog",
      `${VisualLogging.dialog("font-editor").parent("mapped").track({ keydown: "Enter|Escape" })}`
    );
    ...
    new FontPropertyInputs(
      "font-size",
      i18nString(UIStrings.fontSize),
      cssPropertySection,
      fontSizePropertyInfo,
      FontEditorUtils.FontSizeStaticParams,
    ...
    new FontPropertyInputs(
      "line-height",
      i18nString(UIStrings.lineHeight),
      cssPropertySection,
      lineHeightPropertyInfo,
      FontEditorUtils.LineHeightStaticParams,
      this.updatePropertyValue.bind(this),
      this.resizePopout.bind(this),
      /** hasUnits= */
      true
    ...
    new FontPropertyInputs(
      "font-weight",
      i18nString(UIStrings.fontWeight),
      cssPropertySection,
      fontWeightPropertyInfo,
      FontEditorUtils.FontWeightStaticParams,
      this.updatePropertyValue.bind(this),
      this.resizePopout.bind(this),
      /** hasUnits= */
      false
    ...
    new FontPropertyInputs(
      "letter-spacing",
      i18nString(UIStrings.spacing),
      cssPropertySection,
      letterSpacingPropertyInfo,
      FontEditorUtils.LetterSpacingStaticParams,
      this.updatePropertyValue.bind(this),
      this.resizePopout.bind(this),
      /** hasUnits= */
      true
  ...
  createSelector(field, label, options, currentValue, jslogContext) {
    ...
    const deleteButton = new UI.Toolbar.ToolbarButton(i18nString(UIStrings.deleteS, { PH1: label }), "bin", void 0, "delete");
  ...
  updatePropertyValue(propertyName, value) {
    this.dispatchEventToListeners("FontChanged" /* FONT_CHANGED */, { propertyName, value });
  }
  resizePopout() {
    this.dispatchEventToListeners("FontEditorResized" /* FONT_EDITOR_RESIZED */);
  }
}
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["FONT_CHANGED"] = "FontChanged";
  Events2["FONT_EDITOR_RESIZED"] = "FontEditorResized";
  return Events2;
})(Events || {});
class FontPropertyInputs {
  ...
  createSelectorInput(field, jslogContext) {
    const selectInput = UI.UIUtils.createSelect(
      i18nString(UIStrings.sKeyValueSelector, { PH1: this.propertyName }),
