...
import { DataGridImpl, DataGridNode, Events as DataGridEvents } from "./DataGrid.js";
let nextId = 0;
export class ViewportDataGrid extends Common.ObjectWrapper.eventMixin(
  DataGridImpl
) {
  onScrollBound;
  visibleNodes;
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["VIEWPORT_CALCULATED"] = "ViewportCalculated";
  return Events2;
})(Events || {});
