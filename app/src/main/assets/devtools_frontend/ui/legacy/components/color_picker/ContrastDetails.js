...
export class ContrastDetails extends Common.ObjectWrapper.ObjectWrapper {
  ...
  computeSuggestedColor(threshold) {
    ...
    if (threshold === "APCA") {
      ...
      return Common.Color.findFgColorForContrastAPCA(fgColor, bgColor, requiredContrast2 + 1);
    }
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["BACKGROUND_COLOR_PICKER_WILL_BE_TOGGLED"] = "BackgroundColorPickerWillBeToggled";
  return Events2;
})(Events || {});
export class Swatch {
  swatchElement;
