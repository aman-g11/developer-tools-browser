...
export class FilmStripView extends Common.ObjectWrapper.eventMixin(UI.Widget.HBox) {
  ...
  createFrameElement(frame) {
    ...
    element.addEventListener("focusin", this.onMouseEvent.bind(this, "FrameEnter" /* FRAME_ENTER */, time), false);
    element.addEventListener("focusout", this.onMouseEvent.bind(this, "FrameExit" /* FRAME_EXIT */, time), false);
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["FRAME_SELECTED"] = "FrameSelected";
  Events2["FRAME_ENTER"] = "FrameEnter";
  Events2["FRAME_EXIT"] = "FrameExit";
  return Events2;
})(Events || {});
export class Dialog {
  widget;
