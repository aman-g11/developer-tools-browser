...
/*# sourceURL=${import.meta.resolve("./switch.css")} */`;var t=class s extends Event{constructor(e){super(s.eventName),this.checked=e}static eventName="switchchange"},o=class extends HTMLElement{#i=this.attachShadow({mode:"open"});#e=!1;#t=!1;#r="";#o="";connectedCallback(){this.#s()}set checked(e){this.#e=e,this.#s()}get checked(){return this.#e}set disabled(e){this.#t=e,this.#s()}get disabled(){return this.#t}get jslogContext(){return this.#r}set jslogContext(e){this.#r=e,this.#s()}get label(){return this.#o}set label(e){this.#o=e,this.#s()}#a=e=>{this.#e=e.target.checked,this.dispatchEvent(new t(this.#e))};#s(){let e=this.#r&&l.toggle(this.#r).track({change:!0});b(h`
    <style>${i}</style>
    <label jslog=${e||a}>
      <input type="checkbox"
        aria-label=${this.#o||a}
    ...
    `,this.#i,{host:this})}};customElements.define("devtools-switch",o);export{c as Switch};
