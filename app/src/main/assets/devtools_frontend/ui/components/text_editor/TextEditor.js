...
export class TextEditor extends HTMLElement {
  ...
  focus() {
    ...
    for (const dynamicSetting2 of dynamicSettings) {
      ...
      const setting = Common.Settings.Settings.instance().moduleSetting(dynamicSetting2.settingName);
...
const CODE_MIRROR_USER_EVENT_TO_INPUT_EVENT_TYPE = /* @__PURE__ */ new Map([
